if(Meteor.isClient){
  Accounts.onLogin(function() {
    //console.log('login');
        ...
        UserStatus.startMonitor({threshold: 300000}); //Called in order to check if user is idle (300000ms = 5min)
  });

  Accounts.onLogout(function(){
    UserStatus.stopMonitor(); //Call to stop user's idle checking
  });
};
